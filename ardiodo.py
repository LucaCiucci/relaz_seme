...
# Lo script scrive sulla porta seriale a cui e' collegato arduino un numero
# che viene interpretato da arduino come ritardo in unita' di 10 ms
# Poi attende l'arrivo dei dati elaborati da arduino sulla seriale e li salva
# in un file
...
ard.write(b'5') # intervallo (ritardo) in unita' di 10 ms <<<< questo si puo'
                # cambiare (default messo a 50 ms)

print('Start!\n') # scrive sulla console (terminale)
Directory='./data_did/'   # nome directory dove salvare i file dati
FileName=(Directory+'diodefoo.txt') # nomina il file dati <<<< DA CAMBIARE
                                     # SECONDO GUSTO
