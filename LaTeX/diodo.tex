...
\begin{equation}
I = \frac{\Delta V_{resistore}}{R} = I_0 ( e^{\frac{\Delta V_{diodo}}{\eta 
V_t}} - 1)
\end{equation}
...
%================================
\subsection{Apparato}
L'apparato sperimantale è costituito da un circuito, realizzato su basetta 
...
resistenze:\newline
TABELLA\newline
Nel circuito può essere individuata una parte che si ocupa della carica e 
...
La tensione di C1 è misurata attraverso un partitore di tensione collegato ad 
OUT3 ed alla scheda di controllo mentre la tenisone ai punti OUT1 e OUT2 è 
letta direttamente.\newline
Come MCU per la gestione dell'apparato è stata scelta la scheda \verb+Teensy 
3.2+\cite{teensy}, questa si occupa del controllo dei segnali e delle letture 
...
tensione su OUT2 è stata maggiore di 3.3V si ferma l'acquisizione per non 
danneggiare \verb+Teensy+, altrimenti si ricomincia caricando il condensatore 
ad una tensione più alta.
...
Ingenuamente potremmo essere tentati di effettuare una sorta di fit 
“inverso”
