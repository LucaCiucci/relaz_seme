...
$D1$ e la resistenza $R1$. La misura della differenza di tensione ai capi di quest'ultima
permette stima della corrente che attraversa il diodo. Ai fini di esplorare ampie zone 
...
Si è quindi effettuato un filtraggio volto all'eliminazione degli outliers e dei punti meno significativi, assumendoli quali variabili indipendenti e di natura gaussiana. Per una discussione dettagliata si rimanda all' \nameref{app: A}. E’ necessario sottolineare che, all’interno della stessa appendice, $\sigma_x$ rappresenta la varianza delle letture e non gli errori associati ad esse.
