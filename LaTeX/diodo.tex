...
\begin{figure}[H]% so che è brutto che lascia un po' di spazio bianco ma altrimenti lo metterebbe dentro acquisizione dati
	\centering 
...
\begin{align*}
	...
	\text{offset} &=\; - 2.2043\pm 0.0073\rm \mu A\\
...
\begin{figure}[!htbp]% questi vanno sistemati meglio perchè occupano una pagina da soli!!!
	\centering 
