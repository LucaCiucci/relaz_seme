...
%esplorando un'ampia regione della propria curva caratteristica $V - I$,
%tramite campionamenti digitali dei segnali ai capi del componente.
%Discutiamo la presenza di una componente resistiva di un diodo reale e ne
%misuriamo l'entità, al fine di arrivare ad un modello teorico in grado
%giustificare eventuali deviazioni dalla legge di Shockley, verso una risposta
%-ohmica- dovuta alla limitata conducibilità della giunzione PN.\\\\
...
risulta sempre meno trascurabile, all'aumentare della tensione ai suoi capi,
agli effetti del passaggio di corrente attraverso il diodo.
Per poter descrivere questa componente per un diodo percorso da correnti
-alte- si propone un modello semplice, di resistenza parassita in serie,
in grado di descriverne gli effetti, verificandone l'accordo con i dati
sperimentali su un'ampia regione di punti di lavoro.
...
\begin{figure}[!h]
	\centering 
 		\includegraphics[scale=0.23]{confronto_curve.png}
...
\begin{align*}
	R_{\text{diodo}} &= 46.1118 \pm 0.007\underline{2} \; \rm m\Omega \\
	\eta V_T &= 47.5786 \pm 0.003\underline{3} \; \rm mV \\
	I_0 &= 4.5180 \pm 0.004\underline{3} \; \rm nA \\
	\text{offset} &=\; - 2.2043\pm 0.007\underline{3} \;  \mu A\\
...
nei grafici in scala lineare \ref{fig: sck_lin} e semilogaritmica 
\ref{fig: sck_log}
...
\begin{figure}[!h]% questi due grafici sono più problematici, potrebbe tornare utile usare vspace negativo e ritagliare le figure manualmente se necessario
	\centering 
		\includegraphics[scale=0.7]{100skip_linear}
...
\begin{figure}[!ht]
	\centering 
		\includegraphics[scale=0.70]{10skip_semilog}
