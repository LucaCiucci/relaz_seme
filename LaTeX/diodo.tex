...
indipendente dalla scelta del modello per il fit. Le varie serie effettuate,
inoltre, si sovrappongono in alcune zone del grafico. Dunque è stato
necessario eliminare i dati che, non aggiungendo informazioni utili,
andavano a "sporcare" il grafico.
Il sistema di filtraggio di dati implementato
nell'eseguibile si compone di 2 fasi: la prima è l’eliminazione degli outliers, la
seconda consiste nell'eliminazione dei dati non significativi.
%sono arrivata qui
%================================
%         Procedimento
%================================
