...
\begin{align*}
	...
	offset &=\; - 2.2043\pm 0.0073\rm \mu A\\
...
nelle condizioni di lavoro considerate. La modellizzazione proposta può risultare utile nelle simulazini
numeriche di circuiti con diodi in regimi impulsati su alte correnti, dove sia richiesto un dettaglio sulle
cadute di tensioni nei singoli componenti. Per tale scopo la legge \eqref{eq: model} \`e confermata
essere una buona approssimazione del diodo reale entro i limiti sperimentali. Sebbene questo studio
sia stato performato su un unico diodo 1N4007, il metodo proposto pu\`o essere esteso per qualunque
altro tipo di diodo, eventualmente sostituendo il condensatore con un opportuno circuito stabilizzatore
